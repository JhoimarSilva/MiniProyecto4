...
public class VLoginProveedor extends JFrame {
    JButton btnIngresar, btnRegistrar, jButton1, btnRegresar;
    JPanel jpContenido;
    ...
    private void ingresar() {
        ...
        try {
            String fila[] = null;
            FileReader archivo = new FileReader("Login.txt");
    ...
    class ManejadorDeEventos implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            if(e.getSource() == btnRegistrar){
                VRegistroProveedores a = new VRegistroProveedores();
                a.setVisible(true);
                dispose();
                ...
                a.setVisible(true);
                dispose();
            } else if (e.getSource() == checkMostrar){
